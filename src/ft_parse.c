...
/*   Updated: 2016/09/28 18:40:49 by plefebvr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_put_mfw(const char *fmt, int *i, t_info *info, va_list ap)
{
	int		tmp;
	char	*str;
...
void		ft_put_precision(const char *fmt, int *i, t_info *info, va_list ap)
{
	int		tmp;
	char	*str;
...
void		ft_parse_arg(const char *fmt, int *i, t_info *info, va_list ap)
{
	ft_put_flag(fmt, i, info);
	ft_put_mfw(fmt, i, info, ap);
	ft_put_precision(fmt, i, info, ap);
